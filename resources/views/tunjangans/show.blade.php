    ...
    <div class="form-group">
         ...
         <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="Besaran_uang" placeholder="{{$tunjangans->Besaran_uang + $tunjangans->Golongan->Besaran_uang + $tunjangans->Jabatan->Besaran_uang}}" readonly>
            </div>
        </div>
