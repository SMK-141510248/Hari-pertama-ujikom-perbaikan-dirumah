...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{{url('be/b/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css">
    
    <!-- Custom CSS -->
    <link href="{{url('be/b/css/style.css')}}" rel="stylesheet">
    
    <!-- Custom Fonts -->
    <link href="{{url('be/b/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
    
    <!-- Owl Carousel Assets -->
    <link href="{{url('be/b/owl-carousel/owl.carousel.css')}}" rel="stylesheet">
    <link href="{{url('be/b/owl-carousel/owl.theme.css')}}" rel="stylesheet">
...
<body>
        ...
        <div id="nav" class="navbar navbar-default navbar-inner">
            <div class="container">
                ...
                <div class="navbar-header">
                  ...
                  <a href="#page-top" class="navbar-brand navbar-brand-centered"><img src="{{url('be/b/images/logo.png')}}" alt="First slide"></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a class="page-scroll first" href="#nav-services">Services</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#nav-event">Event</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#nav-gallery">Gallery</a>
                        </li>                       
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a class="page-scroll" href="#nav-adventures">Adventures</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#nav-testimonials">Testimonials</a>
                        </li>
                        <li>
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="{{url('be/b/images/karyawan2.jpg')}}" alt="First slide">
                        <!-- Static Header -->
                    ...
                    <div class="item">
                        <img src="{{url('be/b/images/2.jpg')}}" alt="Second slide">
                        <!-- Static Header -->
                        <div class="header-text hidden-xs">
                            <div class="col-md-12 text-center">
                    ...
                    <div class="item">
                        <img src="{{url('be/b/images/3.jpg')}}" alt="Third slide">
                        <!-- Static Header -->
                        <div class="header-text hidden-xs">
                            <div class="col-md-12 text-center">
        ...
        <section class="box-content box-1" id="nav-services">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="box-item">
                            <center><img src="{{url('be/b/images/climbing.png')}}" /></center>
                            <h3>Climbing</h3>
                    ...
                    <div class="col-md-3">
                        <div class="box-item">
                            <center><img src="{{url('be/b/images/fishing.png')}}" /></center>
                            <h3>Fishing</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam viverra convallis auctor. Sed accumsan libero quis mi commodo et suscipit enim lacinia. Morbi rutrum vulputate est sed faucibus.</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="box-item">
                            <center><img src="{{url('be/b/images/camping.png')}}" /></center>
                            <h3>Camping</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam viverra convallis auctor. Sed accumsan libero quis mi commodo et suscipit enim lacinia. Morbi rutrum vulputate est sed faucibus.</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="box-item">
                            <center><img src="{{url('be/b/images/fire.png')}}" /></center>
                            <h3>Campfire</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam viverra convallis auctor. Sed accumsan libero quis mi commodo et suscipit enim lacinia. Morbi rutrum vulputate est sed faucibus.</p>
                        </div>
                    </div>
                ...
                <div class="no-gutter">
                    <div class="col-lg-4 col-sm-6">
                        <a href="#" class="portfolio-box">
                            <img src="{{url('be/b/images/portfolio-1.jpg" class="img-responsive')}}" alt="">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="#" class="portfolio-box">
                            <img src="{{url('be/b/images/portfolio-2.jpg" class="img-responsive')}}" alt="">
                            <div class="portfolio-box-caption">
                                <div class="portfolio-box-caption-content">
                                    <div class="project-category text-faded">
                                        Category
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="#" class="portfolio-box">
                            <img src="{{url('be/b/images/portfolio-3.jpg" class="img-responsive')}}" alt="">
                            <div class="portfolio-box-caption">
                                <div class="portfolio-box-caption-content">
                                    <div class="project-category text-faded">
                                        Category
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="#" class="portfolio-box">
                            <img src="{{url('be/b/images/portfolio-4.jpg" class="img-responsive')}}" alt="">
                            <div class="portfolio-box-caption">
                                <div class="portfolio-box-caption-content">
                                    <div class="project-category text-faded">
                                        Category
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="#" class="portfolio-box">
                            <img src="{{url('be/b/images/portfolio-5.jpg" class="img-responsive')}}" alt="">
                            <div class="portfolio-box-caption">
                                <div class="portfolio-box-caption-content">
                                    <div class="project-category text-faded">
                                        Category
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="#" class="portfolio-box">
                            <img src="{{url('be/b/images/portfolio-6.jpg" class="img-responsive')}}" alt="">
                            <div class="portfolio-box-caption">
                                <div class="portfolio-box-caption-content">
                                    <div class="project-category text-faded">
                                        Category
        ...
        <section class="box-content box-5" id="nav-adventures">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="box-item">
                            <img src="{{url('be/b/images/12.jpg" class="img-responsive')}}"/>
                            <div class="content">
                        ...
                        <div class="box-item">
                            <img src="{{url('be/b/images/13.jpg" class="img-responsive')}}"/>
                            <div class="content">
                    ...
                    <div class="col-md-4">
                        <div class="box-item">
                            <img src="{{url('be/b/images/10.jpg" class="img-responsive')}}"/>
                            <div class="content">
                                <h3>She Said Yes!</h3>
                        ...
                        <div class="box-item">
                            <img src="{{url('be/b/images/11.jpg" class="img-responsive')}}"/>
                            <div class="content">
                    ...
                    <div class="col-md-4">
                        <div class="box-item">
                            <img src="{{url('be/b/images/14.jpg" class="img-responsive')}}"/>
                            <div class="content">
                        ...
                        <div class="box-item">
                            <img src="{{url('be/b/images/15.jpg" class="img-responsive')}}"/>
                            <div class="content">
                ...
                <div class="row">
                    <div id="owl-brand" class="owl-carousel">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="item box-item">
                                    <img src="{{url('be/b/images/partner1.png" class="img-circle')}}" />
                            ...
                            <div class="col-md-6">
                                <div class="item box-item">
                                    <img src="{{url('be/b/images/partner2.png" class="img-circle')}}" />
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley.</p>
                                    <span>Catherine Grace - America</span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="item box-item">
                                    <img src="{{url('be/b/images/partner3.png" class="img-circle')}}" />
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley.</p>
                                    <span>Catherine Grace - America</span>
                                </div>
                            </div>
    ...
    <footer>
        <div class="wrap-footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="copyright">PT.SUKASENANG </div>
                    </div>
                    <div class="col-md-4">
                        <ul class="list-inline social-buttons">
                            <li><a href="#"><i class="fa fa-twitter"></i></a>
    ...
    <!-- jQuery -->
    <script src="{{url('be/b/js/jquery-2.1.1.js')}}"></script>


    <!-- Bootstrap Core JavaScript -->
    <script src="{{url('be/b/js/bootstrap.min.js')}}"></script>

    <!-- Custom Theme JavaScript -->
    <script src="{{url('be/b/js/agency.js')}}"></script>

    <!-- Animated Top -->
    <script src="{{url('be/b/js/jquery.easing.min.js')}}"></script>
    <script src="{{url('be/b/js/classie.js')}}"></script>
    <script src="{{url('be/b/js/cbpAnimatedHeader.js')}}"></script>
